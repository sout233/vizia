use crate::{
    ...
    draw_surface::{create_backend_for_window, DrawSurface},
    window::Window,
...
impl Application {
    ...
    fn create_window(
        ...
        let preferred_backend = &mut self.window_description.graphics_backend;
        ...
        let window = {
            #[cfg(target_os = "windows")]
            {
                ...
                // TODO:
                // We don't know which backend will be chosen at this point.
                // Will it break if dx12 was preferred but is not available?
        ...
        let graphics_backend = create_backend_for_window(
            preferred_backend,
            window_entity,
            window.clone(),
            window_description,
